...
function draw() {
  background(255, 255, 0); // white full canvas background
  noStroke();
  ...
  noStroke();
  texture(bg);
  plane(900, 500); // smaller than canvas
  pop();
